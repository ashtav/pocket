                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                                ...
                                                id="nis" name="nis"
                                                value="{{ $data->nis }}"placeholder="Masukkan nis">
                                            @if ($errors->has('nis'))
                                                <span id="exampleInputEmail1-error"
                                                    class="error invalid-feedback">{{ $errors->first('nis') }}</span>
                                            @endif
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="name" name="name"
                                                value="{{ $data->name }}"placeholder="Masukkan nama">
                                            @if ($errors->has('name'))
                                                <span id="exampleInputEmail1-error"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="phone" name="phone"
                                                value="{{ $data->phone }}"placeholder="Masukkan telp">
                                            @if ($errors->has('phone'))
                                                <span id="exampleInputEmail1-error"
                                                    class="error invalid-feedback">{{ $errors->first('phone') }}</span>
                                            @endif
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="class" name="class"
                                                value="{{ $data->class }}"placeholder="Masukkan kelas">
                                            @if ($errors->has('class'))
                                                <span id="exampleInputEmail1-error"
                                                    class="error invalid-feedback">{{ $errors->first('class') }}</span>
                                            @endif
                                        </div>
                                        <div class="form-group">
                                            <label>Alamat</label>
                                            <textarea class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" rows="3"
                                                placeholder="Masukkan alamat" id="address" name="address">{{ $data->address }}</textarea>
                                            @if ($errors->has('address'))
                                                <span id="exampleInputEmail1-error"
                                                    class="error invalid-feedback">{{ $errors->first('address') }}</span>
                                            @endif
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
