                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="phone" name="phone"
                                                value="{{ old('phone') }}"placeholder="Masukkan telp">
                                            @if ($errors->has('phone'))
                                                <span id="exampleInputEmail1-error"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="class" name="class"
                                                value="{{ old('class') }}"placeholder="Masukkan kelas">
                                            @if ($errors->has('class'))
                                                <span id="exampleInputEmail1-error"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" rows="3"
                                                placeholder="Masukkan alamat" id="address" name="address">{{ old('address') }}</textarea>
