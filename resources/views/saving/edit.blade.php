        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Tabungan Siswa</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Edit Data Tabungan Siswa</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form action="{{ route('savings.update', $data->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="card-body">
                                        <div class="card-body">
                                                ...
                                                <select class="form-control select2bs4" style="width: 100%;"
                                                    ...
                                                    @foreach ($students as $student)
                                                        <option value="{{ $student->id }}"
                                                            @if ($student->id == $data->student_id) selected @endif>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $data->amount }}"placeholder="Masukkan nominal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="note" name="note"
                                                    value="{{ $data->note }}"placeholder="Masukkan catatan">
                                                @if ($errors->has('note'))
                                                    <span id="exampleInputEmail1-error"
